...
app.get('/api/warriors/:id', (req,res) => {
    const warrior = warriors.find(s => s.id === parseInt(req.params.id))
...
app.delete('/api/warriors/:id', (req,res) => {
    const warrior = warriors.find(s => s.id === parseInt(req.params.id))
    if(!warrior) return res.status(404).send('Warrior not found')
    const index = warrior.indexOf(warrior);
...
const warriors = [
    {
        id: "63f3ffb04e41205a5af0577b",
        champion: "Ahri",
        date: "14 de diciembre de 2011",
        splash_art: "https://prod.api.assets.riotgames.com/public/v1/asset/lol/13.15.1/CHAMPION_SKIN/103042/SPLASH",
        origen: "Jonia",
        resource: "Mana",
        position: [
            {
        ...
        habilities: [
            {
                ...
                w: [
                    {
                        abilityIcon: "https://static.wikia.nocookie.net/leagueoflegends/images/7/7e/Ahri_-_W.png/revision/latest/scale-to-width-down/50?cb=20220904214618&path-prefix=es",
                        "title": "Fuego Zorruno",
    ...
    {
        id: "63f3ffd64e41205a5af05784",
        champion: "Aatrox",
        data: "13 de junio de 2013",
                ...
                r: [
                    {
                        ...
                        description: "Aatrox revela su verdadera forma donde aterroriza a los súbditos enemigos cercanos y obtiene daño de ataque, curación aumentada y velocidad de movimiento. Si participa en un asesinato, la duración de la habilidad se extiende.",
                ...
                w: [
                    {
                        ...
                        description: "Akali lanza una cortina de humo y obtiene velocidad de movimiento por un momento. Al estar dentro de ella, se vuelve invisible y no puede ser alcanzada por habilidades y ataques enemigos. Quedará revelada por un instante si ataca o usa habilidades.",
                ...
                e: [
                    {
                        ...
                        description: "Le otorga a Annie o a un campeón aliado seleccionado un escudo, un aumento de velocidad de movimiento e inflige daño mágico a los enemigos que la atacan con ataques básicos.",
                ...
                q: [
                    {
                        ...
                        description: "Ashe acumula Concentración al realizar ataques básicos. Al máximo de acumulaciones, la habilidad puede ser activada y hará que Ashe obtenga más velocidad de ataque y realice múltiples disparos cuando dé un ataque básico.",
                ...
                w: [
                    {
                        ...
                        "title": "Sobremarcha",
                        description: "Blitzcrank recibe un aumento temporal de velocidad de ataque y movimiento.",
                ...
                q: [
                    {
                        ...
                        description: "El siguiente ataque básico de Camille inflige daño físico adicional y le otorga una bonificación de velocidad de movimiento. Después de unos segundos, Camille puede reactivar la habilidad para infligir más daño físico y también daño verdadero.",
                ...
                q: [
                    {
                        ...
                        description: "Cassiopeia lanza un gas nocivo en el lugar seleccionado, infligiendo daño mágico a los enemigos que se encuentren dentro del área y envenenándolos por unos segundos. Si el enemigo es un campeón, Cassiopeia obtiene velocidad de movimiento adicional.",
